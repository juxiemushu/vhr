...
public class TableCodeInitialization {
     ...
     * 数据库地址
     */
    private static final String DB_URL="jdbc:mysql://127.0.0.1:3306/dd_home?useUnicode=true&useSSL=false&characterEncoding=utf8&useTimezone=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true&useServerPrepStmts=true&allowMultiQueries=true";
    /**
     * db 账号
     */
